...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'task.create' => [ \App\Http\Middleware\Task\CanDescriptionCreate::class ],
        'task.update.status' => [ \App\Http\Middleware\Task\CanTaskUpdateStatus::class ],
        'task.assigned' => [ \App\Http\Middleware\Task\IsDescriptionAssigned::class ],
        ...
        'description.create' => [ \App\Http\Middleware\Description\CanDescriptionCreate::class ],
        'description.assigned' => [ \App\Http\Middleware\Description\IsDescriptionAssigned::class ],
        'api' => [
            'throttle:60,1',
            'bindings',
        ],
